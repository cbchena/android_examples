...
public class LISAImageGray16BitWriter extends FileOutputStream {
	 ...
	 * @throws IOException
	 */
	public void write(LISAImageGray16Bit image, String filePath) throws IOException {
		...
		try {
            ...
            File dcmInfo = new File(filePath + ".dcminfo");
            FileOutputStream outs = new FileOutputStream(dcmInfo);
            String str = "";
            String value;
            for (String s : image.getAttributes().keySet()) {
                value = image.getAttributes().get(s);
