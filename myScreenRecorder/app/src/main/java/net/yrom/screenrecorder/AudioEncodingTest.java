...
public class AudioEncodingTest {
    ...
    public static void testAACEncoders(Context c) throws IOException {
    ...
    private static void testEncoderWithFormats(
            String mime, List<MediaFormat> formats, Context c) throws IOException {
    ...
    private static void testEncoder(String componentName, MediaFormat format, Context c) throws IOException {
        int trackIndex = 0;
