...
public class InitActivity extends Activity {
	...
	private static class UIHandler extends Handler {
		...
		public void handleMessage(Message msg) {
			...
			case 0:
				ctx.mPD.dismiss();
                ctx.mVideoView.setVideoURI(Uri.parse("http://www.modrails.com/videos/passenger_nginx.mov"));
                ctx.mVideoView.setMediaController(new MediaController(ctx));
                ctx.mVideoView.requestFocus();
                ctx.mVideoView.setVideoLayout(VideoView.VIDEO_LAYOUT_STRETCH, 0); // 全屏
